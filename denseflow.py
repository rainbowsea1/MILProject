...
def parse_args():
    ...
    parser.add_argument('--dataset', default='UCF_Crime_100GB', type=str,
...
if __name__ == '__main__':
    ...
    args = parse_args()
    dataset = 'UCF_Crime_100GB'
    data_root = 'E:/datasets/UCF_Crime_100GB/Abuse/Abuse.txt'
